...
/*
 * fs/susfs.c (added by the kernel-side SUSFS patch) declares:
 *   extern bool susfs_is_current_ksu_domain(void);
 * and calls it directly - it does not need or call any of the other
 * zygote/init/sid helpers an earlier draft of this integration added
 * here; this fork already has working, cached domain checks
 * (is_ksu_domain(), is_zygote()) that we just delegate to.
 */
